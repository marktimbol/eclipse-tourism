...
class UserMailer extends Mailer {	
	...
	{
		$subject = sprintf('%s: %s', config('eclipse.name'), 'Your Payment Receipt');
	...
	{	
		$subject = sprintf('%s: %s', config('eclipse.name'), 'Your Booking Date was confirmed!');
	...
	{	
		$subject = sprintf('%s: %s', config('eclipse.name'), 'Your Booking Information');
	...
	{
		$subject = sprintf('%s: %s', config('eclipse.name'), 'Your purchase was not successfully processed.');
	...
	{
		$subject = sprintf('%s: %s', config('eclipse.name'), 'Your booking was not successfully processed.');
		$view = 'emails.template';
