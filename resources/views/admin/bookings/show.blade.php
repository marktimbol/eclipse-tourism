...
{{--                                 <li class="list-group-item"><strong>City:</strong> {{ $user->city }}</li>
                        ...
                        <div class="col-md-6">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item"><strong>Name:</strong> {{ $user->cardName }}</li>
                                <li class="list-group-item"><strong>Brand:</strong> {{ $user->cardBrand }}</li>
                                ...
                                <li class="list-group-item"><strong>Expiry:</strong> 
                                    {{ $user->cardExpiryMonth ? $user->cardExpiryMonth . '/' . $user->cardExpiryYear : '' }}
                                </li>
                            </ul>  
                        </div>
                    </div>
