...
var BookPackageForm = React.createClass({
	...
	handleAdultQuantityChange: function handleAdultQuantityChange(e) {
		this.setState({ quantity: e.target.value });
	},
	handleChildQuantityChange: function handleChildQuantityChange(e) {
	...
	render: function render() {
		...
		return React.createElement(
			'div',
			{ className: 'book-a-package-form' },
			React.createElement(
				'h3',
				{ className: 'book-a-package-form__title' },
				'Book this package'
			),
			React.createElement(
				'form',
				{ method: 'POST', onSubmit: this.beforeSubmitForm },
				React.createElement(
					'div',
					{ className: 'row' },
					React.createElement(
						'div',
						{ className: 'col m12 mb-0' },
						React.createElement(
							'div',
							...
							React.createElement(
								...
								React.createElement('input', { name: 'date', type: 'text', className: 'form-control datepicker', onChange: this.handleDateChange })
							)
						)
					),
					React.createElement(
						'div',
						{ className: 'col m12 mb-0', style: preferredTimingsStyle },
						React.createElement(
							'div',
							{ className: 'form-group' },
							React.createElement(
							...
							React.createElement(
								'select',
								{ defaultValue: this.state.time, className: 'form-control', onChange: this.handleTimeChange },
								React.createElement(
									'option',
									{ value: '', disabled: true },
									'Choose your option'
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								'select',
								{ className: 'form-control', value: this.state.ticket, onChange: this.fetchTicketPrice },
								React.createElement(
									'option',
									{ value: '0' },
									'Choose your ticket'
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										'select',
										{ defaultValue: this.state.quantity, className: 'form-control', onChange: this.handleAdultQuantityChange },
										adultsCount
									)
								)
							),
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										'select',
										{ defaultValue: this.state.child_quantity, className: 'form-control', onChange: this.handleChildQuantityChange },
										childsCount
									)
								)
							)
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								'button',
								{ type: 'submit', className: 'btn btn-large waves-effect waves-light full-width', disabled: this.state.isFormSubmitted, onClick: this.beforeSubmitForm },
								this.state.buttonText,
								this.state.isFormSubmitted ? React.createElement('i', { className: 'fa fa-spinner fa-spin' }) : ''
							)
						)
					)
				)
...
exports.default = BookPackageForm;
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement('img', { src: imagePath, alt: this.props.currentPackage.name, title: this.props.currentPackage.name, className: 'img-responsive' })
				),
				React.createElement(
					'div',
...
var PackageInfo = React.createClass({
	...
	render: function render() {
		var additionalInformation = this.props.currentPackage.information.map(function (info) {
			return React.createElement(
				'li',
				{ key: info.id, className: 'collection-item' },
				React.createElement(
					'strong',
					null,
					info.title
		...
		return React.createElement(
			...
			React.createElement(
				...
				!this.props.displayPrice ? React.createElement(
					'span',
					null,
					'---'
				) : React.createElement(
					'span',
					null,
					this.props.currentPackage.confirm_availability == 1 ? 'Upon Request' : React.createElement(
						'span',
						null,
			...
			this.props.currentPackage.minimum_quantity > 1 ? React.createElement(
				...
				React.createElement(
					'strong',
					null,
					'Minimum Adult Quantity:'
				),
				this.props.currentPackage.minimum_quantity
			) : '',
			this.props.currentPackage.confirm_availability ? React.createElement(
				'li',
				{ className: 'collection-item' },
...
var _PackagePhotos = require('./PackagePhotos');

var _PackagePhotos2 = _interopRequireDefault(_PackagePhotos);

var _PackagePrice = require('./PackagePrice');

var _PackagePrice2 = _interopRequireDefault(_PackagePrice);

var _PackageInfo = require('./PackageInfo');

var _PackageInfo2 = _interopRequireDefault(_PackageInfo);

var _TicketOptions = require('./TicketOptions');

var _TicketOptions2 = _interopRequireDefault(_TicketOptions);

var _BookPackageForm = require('./BookPackageForm');

var _BookPackageForm2 = _interopRequireDefault(_BookPackageForm);

var _SharePackage = require('./SharePackage');

var _SharePackage2 = _interopRequireDefault(_SharePackage);
...
var PackageInformation = React.createClass({
	...
	setPrices: function setPrices(ticketId, adultPrice, childPrice) {
		this.setState({
	...
	render: function render() {
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(_PackagePhotos2.default, { photos: window.package.photos }),
				React.createElement(
					'div',
					{ className: 'package__description' },
					React.createElement(
						'h3',
						null,
						window.package.subtitle
					),
					React.createElement('div', { dangerouslySetInnerHTML: this.showDescription() })
				)
			),
			React.createElement(
				'div',
				{ className: 'col m3 s12' },
				React.createElement(_PackagePrice2.default, {
					displayPrice: this.state.displayPrice,
					adultPrice: this.state.adultPrice,
					currentPackage: window.package }),
				React.createElement(_PackageInfo2.default, {
					displayPrice: this.state.displayPrice,
					adultPrice: this.state.adultPrice,
					childPrice: this.state.childPrice,
					currentPackage: window.package }),
				React.createElement(_BookPackageForm2.default, {
					setPrices: this.setPrices,
					selectedTicket: this.state.selectedTicket,
					currentPackage: window.package }),
				React.createElement(_SharePackage2.default, { url: packageUrl })
			),
			React.createElement(
				'div',
				{ className: 'col s12 m12' },
				window.package.has_ticket_option ? React.createElement(_TicketOptions2.default, { currentPackage: window.package }) : ''
			)
		);
	}
});
...
},{"./BookPackageForm":160,"./PackageInfo":162,"./PackagePhotos":165,"./PackagePrice":166,"./SharePackage":168,"./TicketOptions":169,"react":159,"react-dom":30}],164:[function(require,module,exports){
"use strict";
...
var PackagePhoto = React.createClass({
	displayName: "PackagePhoto",
	render: function render() {
		return React.createElement(
			"div",
			null,
			React.createElement("img", { src: this.props.path, className: "img-responsive" })
		);
	}
});

exports.default = PackagePhoto;
...
var _PackagePhoto = require('./PackagePhoto');

var _PackagePhoto2 = _interopRequireDefault(_PackagePhoto);
...
var PackagePhotos = React.createClass({
	...
	render: function render() {
		...
		var photos = this.props.photos.map(function (photo) {
			return React.createElement(_PackagePhoto2.default, { key: photo.id, path: uploadspath + photo.path });
		});
...
exports.default = PackagePhotos;

},{"./PackagePhoto":164,"react":159}],166:[function(require,module,exports){
'use strict';
...
},{"numeral":28,"react":159}],167:[function(require,module,exports){
'use strict';
	...
	render: function render() {
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					'h4',
					{ className: 'package__related__title' },
					'Related Packages'
				)
			),
			packages
...
ReactDOM.render(React.createElement(RelatedPackages, null), document.getElementById('RelatedPackages'));

},{"./Package":161,"react":159,"react-dom":30}],168:[function(require,module,exports){
"use strict";
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					"li",
					null,
					React.createElement("div", { className: "fb-share-button", "data-href": this.props.url, "data-layout": "button_count" })
				),
				React.createElement(
					"li",
					null,
    ...
    render: function render() {
        var tickets = this.props.currentPackage.tickets.map(function (ticket) {
            var information = ticket.information.map(function (information) {
                return React.createElement(
                    "li",
                    { key: information.id, className: "collection-item" },
                    React.createElement(
                        "strong",
                        null,
                        information.name
            ...
            return React.createElement(
                "div",
                { className: "col s12 m4", key: ticket.id },
                React.createElement(
                    "div",
                    { className: "card z-depth-1" },
                    React.createElement(
                        "div",
                        { className: "card-image light-blue waves-effect" },
                        React.createElement(
                            "div",
                        ...
                        React.createElement(
                            ...
                            ticket.adultPrice == 0 ? ticket.childPrice : ticket.adultPrice
                        ),
                        React.createElement(
                            "p",
...
exports.default = TicketOptions;

},{"react":159}]},{},[163,167]);

//# sourceMappingURL=PackagePage.js.map
