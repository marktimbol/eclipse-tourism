	...
	render: function render() {
		...
		return React.createElement(
			...
			React.createElement(
				'div',
				{ className: 'col m3 s12' },
				React.createElement(_PackagePrice2.default, { currentPackage: window.package, adultPrice: this.state.adultPrice }),
				React.createElement(_PackageInfo2.default, { currentPackage: window.package, adultPrice: this.state.adultPrice, childPrice: this.state.childPrice }),
...
},{"./BookPackageForm":160,"./PackageInfo":162,"./PackagePhotos":165,"./PackagePrice":166,"./SharePackage":168,"react":159,"react-dom":30}],164:[function(require,module,exports){
"use strict";
