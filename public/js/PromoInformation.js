...
},{"./PackagePhoto":161,"react":159}],163:[function(require,module,exports){
'use strict';
	...
	render: function render() {
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(_PackagePhotos2.default, { photos: window.promo.photos }),
				React.createElement(
					'div',
			...
			React.createElement(
				...
				React.createElement(_SharePackage2.default, { url: promoUrl })
			)
		);
	}
});

ReactDOM.render(React.createElement(PromoInformation, null), document.getElementById('PromoInformation'));

},{"./PackageInfo":160,"./PackagePhotos":162,"./PackagePrice":163,"./SharePackage":165,"react":159,"react-dom":30}],165:[function(require,module,exports){
"use strict";
...
//# sourceMappingURL=PromoInformation.js.map
