...
var AdditionalPackageInformation = React.createClass({
	displayName: "AdditionalPackageInformation",
...
exports.default = AdditionalPackageInformation;
...
var NewTicket = React.createClass({
	...
	render: function render() {
		return React.createElement(
			'div',
			{ className: 'modal fade', id: 'newTicket', role: 'dialog' },
			React.createElement(
				'div',
				{ className: 'modal-dialog', role: 'document' },
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement('input', { className: 'form-control', placeholder: '1 day ticket',
...
var _AdditionalPackageInformation = require('./AdditionalPackageInformation');

var _AdditionalPackageInformation2 = _interopRequireDefault(_AdditionalPackageInformation);
...
var PackageInformationList = React.createClass({
	displayName: 'PackageInformationList',
	onDelete: function onDelete(id) {
...
var _TicketInfo = require('./TicketInfo');
...
var Ticket = React.createClass({
	...
	resetTicketInformationInput: function resetTicketInformationInput() {
		this.setState({
			ticketName: '',
			ticketDescription: ''
		});
				...
				this.state.editing ? React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement('input', { className: 'form-control', value: this.state.duration, onChange: this.handleDurationChange })
							)
						),
						React.createElement(
							'div',
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								'button',
								{ type: 'button', className: 'btn btn-default btn-sm', onClick: this.showForm },
								'New Info'
							),
							' ',
							this.state.showForm ? React.createElement(
								'button',
								{ type: 'button', className: 'btn btn-default btn-sm', onClick: this.hideForm },
								'Hide Form'
							) : ''
						)
					),
					this.state.showForm ? React.createElement(
						...
						React.createElement(
							'form',
							{ method: 'POST', className: 'form-inline', onSubmit: this.onSubmitTicketInformation },
							React.createElement('input', { type: 'hidden', name: '_token', value: csrfToken }),
							React.createElement(
								'div',
								{ className: 'col-md-5' },
								React.createElement(
									...
									React.createElement('input', { className: 'form-control input-sm', placeholder: 'Name',
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement('input', { className: 'form-control input-sm', placeholder: 'Description',
...
},{"./TicketInfo":165,"react":158}],165:[function(require,module,exports){
'use strict';
...
var _NewTicket = require('./NewTicket');

var _NewTicket2 = _interopRequireDefault(_NewTicket);
...
var Tickets = React.createClass({
	...
	onSubmit: function onSubmit(name, duration, adultPrice, childPrice) {
	...
	onUpdate: function onUpdate(id, name, duration, adultPrice, childPrice) {
	...
	render: function render() {
		var tickets = this.state.tickets.map((function (item) {
			return React.createElement(_Ticket2.default, { key: item.id,
				ticket: item,
				onUpdate: this.onUpdate,
				onUpdateInformation: this.onUpdateInformation,
				onDelete: this.onDelete,
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					'button',
					{ type: 'button', className: 'btn btn-primary btn-sm', 'data-toggle': 'modal', 'data-target': '#newTicket' },
					'Add New Ticket'
				)
			),
			React.createElement(_NewTicket2.default, { onSubmit: this.onSubmit })
		);
	}
});

ReactDOM.render(React.createElement(Tickets, null), document.getElementById('Tickets'));

},{"./NewTicket":161,"./Ticket":164,"react":158,"react-dom":29}]},{},[162,166]);
