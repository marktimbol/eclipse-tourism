...
var _EditCartModal = require('./EditCartModal');

var _EditCartModal2 = _interopRequireDefault(_EditCartModal);
...
var CartItem = React.createClass({
	...
	deleteCartItem: function deleteCartItem(rowId) {
	...
	render: function render() {
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'col m3' },
						React.createElement('img', { src: imagePath, className: 'materialboxed img-rounded', width: '100', alt: this.props.item.name, title: this.props.item.name })
					),
					React.createElement(
						'div',
						{ className: 'col m8' },
						React.createElement(
							'div',
							{ className: 'cart__package' },
							React.createElement(
								'h4',
								{ className: 'cart__package__title' },
								React.createElement(
									'a',
									{ href: packageUrl },
							...
							React.createElement(
								...
								this.props.item.options.selectedPackage.has_time_options ? React.createElement(
									'span',
									null,
									'  at  ',
							...
							selectedTicket ? React.createElement(
								'p',
								{ className: 'text-muted' },
								selectedTicket + ' - ' + ticketDuration
							) : '',
							this.props.item.options.selectedPackage.confirm_availability ? React.createElement(
								'p',
								{ className: 'text-muted' },
								'* Subject for Availability'
							) : '',
							this.props.item.options.child_quantity > 0 ? React.createElement(
								'ul',
			...
			React.createElement(
				'td',
				{ className: 'nowrap' },
				currentCurrency + ' ' + numeral(this.props.item.subtotal).format('0,0')
			),
			React.createElement(
				'td',
				null,
				React.createElement(
					'a',
					{ className: 'modal-trigger', onClick: this.openModal },
					React.createElement('i', { className: 'fa fa-pencil' }),
					' Edit'
				),
				React.createElement(_EditCartModal2.default, { key: this.props.item.rowid, item: this.props.item,
...
},{"./EditCartModal":165,"numeral":28,"react":159}],162:[function(require,module,exports){
'use strict';
...
var _CheckoutLink = require('./CheckoutLink');

var _CheckoutLink2 = _interopRequireDefault(_CheckoutLink);

var _EmptyShoppingCart = require('./EmptyShoppingCart');

var _EmptyShoppingCart2 = _interopRequireDefault(_EmptyShoppingCart);

var _ChangeCurrencyForm = require('./ChangeCurrencyForm');

var _ChangeCurrencyForm2 = _interopRequireDefault(_ChangeCurrencyForm);
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					...
					this.state.cartCount !== 0 ? React.createElement(_CheckoutLink2.default, { link: '/cart/checkout' }) : React.createElement(_EmptyShoppingCart2.default, null)
				)
			)
		);
	}
...
ReactDOM.render(React.createElement(CartTable, null), document.getElementById('CartTable'));

},{"./Amount":160,"./CartItem":161,"./ChangeCurrencyForm":163,"./CheckoutLink":164,"./EmptyShoppingCart":166,"numeral":28,"react":159,"react-dom":30}],163:[function(require,module,exports){
'use strict';
...
var ChangeCurrencyForm = React.createClass({
	displayName: 'ChangeCurrencyForm',
	getInitialState: function getInitialState() {
		return {
	...
	render: function render() {
		...
		return React.createElement(
			...
			React.createElement(
				'form',
				{ action: '/change-currency', className: 'form-inline' },
				React.createElement(
					'div',
...
exports.default = ChangeCurrencyForm;
	...
	render: function render() {
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					'form',
					{ method: 'POST', onSubmit: this.onDelete },
					React.createElement('input', { type: 'hidden', name: '_method', value: 'DELETE' }),
					React.createElement(
						'button',
						{ type: 'submit', className: 'btn-flat center-content' },
						React.createElement(
							'i',
