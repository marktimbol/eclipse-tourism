		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement('div', { className: 'svg', dangerouslySetInnerHTML: this.showSVG() }),
					React.createElement(
						'div',
						{ className: 'card__content' },
						React.createElement('i', { className: 'card__btn-close fa fa-times' }),
						React.createElement(
							'div',
							...
							React.createElement(
								...
								this.props.currentPackage.subtitle
							)
						),
						React.createElement(
							'div',
								...
								React.createElement(
									...
									React.createElement(
										...
										React.createElement(
											...
											React.createElement('p', { dangerouslySetInnerHTML: this.showDescription() })
										),
										React.createElement(
											'div',
											{ className: 'col m3 s12' },
											React.createElement(_PackagePrice2.default, { currentPackage: this.props.currentPackage, adultPrice: this.props.currentPackage.adult_price }),
											React.createElement(_PackageInfo2.default, { currentPackage: this.props.currentPackage, adultPrice: this.props.currentPackage.adult_price, childPrice: this.props.currentPackage.child_price }),
											React.createElement(
												'a',
												{ href: packageUrl, className: 'btn btn-large btn-block waves-effect waves-light blue' },
												'View Package'
											)
										)
									)
...
exports.default = FeaturedPackage;

},{"./PackageInfo":163,"./PackagePrice":164,"react":159}],161:[function(require,module,exports){
'use strict';

var _FeaturedPackage = require('./FeaturedPackage');
...
var FeaturedPackages = React.createClass({
	...
	render: function render() {
		...
		var featuredPackages = window.packages.map(function (currentPackage) {
			return React.createElement(_FeaturedPackage2.default, { key: currentPackage.id, currentPackage: currentPackage });
		});
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					'h3',
					{ className: 'featured__package__title' },
					'Featured Packages'
				)
			),
			React.createElement('div', { className: 'pattern pattern--hidden' }),
			featuredPackages
		);
	}
});

ReactDOM.render(React.createElement(FeaturedPackages, null), document.getElementById('FeaturedPackages'));

},{"./FeaturedPackage":160,"react":159,"react-dom":30}],162:[function(require,module,exports){
'use strict';
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement('img', { src: '/images/home-slide1.jpg', className: 'img-responsive', alt: 'See latest offers', title: 'See latest offers' })
						),
						React.createElement(
							'div',
							{ className: 'col s12 m4' },
							React.createElement(
								...
								React.createElement(
									'h3',
									{ className: 'home__message__title' },
									'Lorem ipsum dolor sit amet.'
								),
								React.createElement(
									'p',
									{ className: 'home__message__description' },
									'Ipsum has been the industrys standard dummy text ever since the 1500s.'
								),
								React.createElement(
									'a',
									{ href: '/packages', className: 'btn waves-effect waves-light blue' },
...
ReactDOM.render(React.createElement(HomeBanner, null), document.getElementById('HomeBanner'));
...
},{"numeral":28,"react":159}],165:[function(require,module,exports){
'use strict';
	...
	render: function render() {
		...
		return React.createElement(
			...
			React.createElement(
				'div',
				{ className: 'slideshow' },
				React.createElement('div', { id: 'topLeftCorner' }),
				React.createElement(
					'div',
					{ className: 'logo' },
					React.createElement(
						'a',
						{ href: '/' },
						React.createElement('img', { src: logoPath, alt: 'Eclipse Tourism', title: 'Eclipse Tourism', className: 'img-responsive' })
					)
				),
				React.createElement('div', { id: 'bottomRightCorner' }),
				React.createElement(
					'video',
					{ id: 'top_video', autoPlay: true, loop: true, preload: true, muted: true, poster: '' },
					React.createElement('source', { src: videoMp4Path, type: 'video/mp4' }),
					React.createElement('source', { src: videoWebmPath, type: 'video/webm' })
				),
				React.createElement(
					'div',
					{ id: 'intro-title' },
...
ReactDOM.render(React.createElement(Slideshow, null), document.getElementById('Slideshow'));

},{"react":159,"react-dom":30}]},{},[165,162,161]);
